...
public final class PreferencesKonfigSource implements KonfigSource {
    ...
    public PreferencesKonfigSource(final Preferences preferences, final Deserializer<String> deserializer) {
        this.deser = Objects.requireNonNull(deserializer, "deserializer");
        this.pref = Objects.requireNonNull(preferences, "preferences");
        this.lastHash = hashOf(pref);
    }

    public PreferencesKonfigSource(final Preferences preferences) {
