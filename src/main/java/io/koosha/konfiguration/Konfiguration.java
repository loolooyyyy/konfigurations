...
public interface Konfiguration {
     ...
     * @return konfiguration value wrapper for the requested key.
     */
    <U> K<List<U>> list(String key, Q<List<U>> type);
     ...
     * @return konfiguration value wrapper for the requested key.
     */
    <U, V> K<Map<U, V>> map(String key, Q<Map<U, V>> type);
     ...
     * @return konfiguration value wrapper for the requested key.
     */
    <U> K<Set<U>> set(String key, Q<Set<U>> type);
     ...
     * @return konfiguration value wrapper for the requested key.
     */
    <U> K<U> custom(String key, Q<U> type);
     ...
     */
    @SuppressWarnings("unused")
    default Konfiguration subset(String key) {
        nn(key, "key");
        return this.subset(this.getName() + "::" + key, key);
    }

    Konfiguration subset(final String name, final String key);
     ...
     */
    static Konfiguration map(final Map<String, ?> storage) {
        return map("", storage);
    }
     ...
     */
    static Konfiguration map(final Supplier<Map<String, ?>> storage) {
        return map("", storage);
    }
     ...
     * @throws NullPointerException if storage is null.
     */
    static Konfiguration map(final String name,
                             final Map<String, ?> storage) {
        nn(name, "name");
        nn(storage, "storage");
        return new KonfigSources.MapKonfiguration(name, true, () -> storage);
    }
    ...
    static Konfiguration map(final String name,
        ...
        return new KonfigSources.MapKonfiguration(name, false, storage);
    }
    ...
    static Konfiguration preferences(final String name,
                                     final Preferences preferences) {
        return new KonfigSources.PreferencesKonfiguration(name, false, preferences, null);
    }
     ...
     */
    static Konfiguration jacksonJson_(final String json) {
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration jacksonJson_(String json, final Supplier<ObjectMapper> objectMapper) {
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration jacksonJson_(final Supplier<String> json) {
        return jacksonJson("", json);
    }
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration jacksonJson(final String name,
                                     final String json) {
        return new KonfigSources.JsonKonfigSource(name, true, () -> json);
    }
    ...
    static Konfiguration jacksonJson(final String name,
                                     String json,
                                     final Supplier<ObjectMapper> objectMapper) {
        return new KonfigSources.JsonKonfigSource(name, true, () -> json, objectMapper);
    }
    ...
    static Konfiguration jacksonJson(final String name,
        ...
        return new KonfigSources.JsonKonfigSource(name, false, json);
    }
    ...
    static Konfiguration jacksonJson(final String name,
                                     final Supplier<String> json,
                                     final Supplier<ObjectMapper> objectMapper) {
        return new KonfigSources.JsonKonfigSource(name, false, json, objectMapper);
    }
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration snakeYaml_(final String yaml) {
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration snakeYaml_(final Supplier<String> yaml) {
        return snakeYaml("", yaml);
    }
     ...
     * @throws KfgSourceException if the the root element returned by jackson is null.
     */
    static Konfiguration snakeYaml(final String name,
                                   final String yaml) {
        return new KonfigSources.SnakeYamlKonfigSource(name, true, () -> yaml);
    }
    ...
    static Konfiguration snakeYaml(final String name,
                                   final String yaml,
                                   final Supplier<Yaml> objectMapper) {
        return new KonfigSources.SnakeYamlKonfigSource(name, true, () -> yaml, objectMapper);
    }
    ...
    static Konfiguration snakeYaml(final String name,
        ...
        return new KonfigSources.SnakeYamlKonfigSource(name, false, yaml);
    }
    ...
    static Konfiguration snakeYaml(final String name,
                                   final Supplier<String> yaml,
                                   final Supplier<Yaml> objectMapper) {
        return new KonfigSources.SnakeYamlKonfigSource(name, false, yaml, objectMapper);
    }
